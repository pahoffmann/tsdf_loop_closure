...
Die Truncated Signed Distance Funtion ist eine Form der \textbf{impliziten Oberflächenbeschreibung}. Sie beschreibt die Oberfläche nicht direkt, sondern den Raum um die Oberfläche herum.
Als Grundlage dient dazu eine diskrete Aufteilung des Raumes in \textbf{Voxel} zum Beispiel in Form einer \improvement{Einfügen, wie die entsprechenden Kartentypen heißen}.
Die Seitenlänge $x$ der Voxel ist dabei frei wählbar.
