...
Dabei werden von verschiedenen Positionen im dreidmensionalen Raum \textbf{(Posen)} Punktwolken aufgnommen. Um diese Punktwolken nahtlos aneinander anknüpfen zu können, müssen diese miteinander \textbf{registriert} werden. Die Registrierung bestimmt die 3D Transformation (siehe dazu Kapitel \ref{section:transformationen}) zwischen zwei Punktwolken, wobei die \textbf{Scan-Punktwolke} an die \textbf{Model-Punktwolke} registriert wird.
